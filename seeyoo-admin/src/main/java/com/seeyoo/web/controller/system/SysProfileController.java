...
import com.seeyoo.common.annotation.Log;
import com.seeyoo.common.config.YooConfig;
import com.seeyoo.common.constant.UserConstants;
import com.seeyoo.common.core.controller.BaseController;
...
import com.seeyoo.common.utils.file.FileUploadUtils;
import com.seeyoo.common.utils.file.MimeTypeUtils;
...
public class SysProfileController extends BaseController
{
    ...
    public AjaxResult updatePwd(String oldPassword, String newPassword)
    {
        ...
        String password = userService.selectUserById(loginUser.getUser().getUserId()).getPassword();
    ...
    public AjaxResult avatar(@RequestParam("avatarfile") MultipartFile file) throws Exception
    {
        ...
        {
            LoginUser loginUser = getLoginUser();
            String avatar = FileUploadUtils.upload(YooConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION);
